...
class Multiranger:
    ...
    def __init__(self, crazyflie, rate_ms=100, zranger=False):
        ...
        self._four_dist = [self._front_distance, self._back_distance, self._left_distance, self._right_distance]
...
print("Using updated multiranger.py")
